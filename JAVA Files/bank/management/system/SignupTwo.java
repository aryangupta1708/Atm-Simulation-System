...
public class SignupTwo extends JFrame implements ActionListener{
    ...
    SignupTwo(String formno){
        ...
        String valRegligion[]={"Hindu","Muslim","Sikh","Christian","Other"};
        religion = new JComboBox(valRegligion);
    ...
    public void actionPerformed(ActionEvent ae){
        //it's long value need to convert it to string if entering into DB
        ...
        try{
                ...
                //signup3 object to open next page
                setVisible(false);
